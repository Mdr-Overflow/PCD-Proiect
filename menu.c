...
// gcc menu.c bmp2jpeg.c bmp2png.c jpeg2bmp.c jpeg2png.c png2bmp.c png2jpeg.c bmp_tint.c jpeg_blurr.c jpeg_grayscale.c jpeg_tint.c png_blurr.c png_grayscale.c png_tint.c bmp_stats.c png_stats.c jpeg_stats.c -o menu -ljpeg -lpng && ./menu e2.jpg
